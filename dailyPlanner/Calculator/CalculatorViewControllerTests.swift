...
final class CalculatorViewControllerTests: XCTestCase {
    ...
    func testNumbersButtonPressed() {
        ...
        XCTAssertEqual(calculatorVC.label.text, "1")
        XCTAssertEqual(calculatorVC.numberOnScreen, 1.0)
    ...
    func testEqualButtonPressed() {
        ...
        XCTAssertEqual(calculatorVC.label.text, "0.5")
        ...
        XCTAssertEqual(calculatorVC.label.text, "1.5")
        ...
        XCTAssertEqual(calculatorVC.label.text, "-2.5")
